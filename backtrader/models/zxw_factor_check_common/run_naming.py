"""因子检验模型的 run_name 后缀与日期前缀（与 可视化/run_name_format 对齐）。"""
...
def build_run_name_base(
    ...
    """示例：ZXW因子检验_买A_B_卖X_Y（再由服务端加 202401_to_06 等日期前缀）。"""
    base = str(user_base or "").strip() or "ZXW因子检验"
...
def build_full_run_name(
    *,
    ...
    """完整名称：202401_to_06ZXW因子检验_买A_B_卖X_Y。"""
    prefix = build_run_name_date_prefix(start_date, end_date)
