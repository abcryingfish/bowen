...
def run(
    *,
    ...
    p("运行回测", 75, "Backtrader 执行 FactorCheckDualAssumptionZxwStrategy")
    result = run_zxw_backtest(
        target_codes=actual_codes,
        df_multi=clip_df,
        strategy_cls=FactorCheckDualAssumptionZxwStrategy,
