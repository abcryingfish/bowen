...
from models.zxw_factor_check_sell_signal_step_position.daily_move_guard import DEFAULT_DAILY_MOVE_LIMIT
from models.zxw_factor_check_sell_signal_step_position.profit_threshold_strategy import (
...
def run(
    *,
    ...
    p("运行回测", 75, "Backtrader 执行 FactorCheckSellSignalStepPositionZxwStrategy")
    result = run_zxw_backtest(
        target_codes=actual_codes,
        df_multi=clip_df,
        strategy_cls=FactorCheckSellSignalStepPositionZxwStrategy,
    ...
    config_payload: dict[str, Any] = {
        ...
        "backtest_engine": "models/zxw_factor_check_sell_signal_step_position + zxw_data_pipeline 宽表",
        "strategy_class": "FactorCheckSellSignalStepPositionZxwStrategy",
        "enable_future_halving_mask": False,
