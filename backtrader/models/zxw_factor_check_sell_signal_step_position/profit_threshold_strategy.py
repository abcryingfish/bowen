...
from models.zxw_factor_check_sell_signal_step_position.daily_move_guard import (
...
class FactorCheckSellSignalStepPositionZxwStrategy(FactorCheckDailyMoveGuardStrategy):
    """
    在双假设因子检验基础上增加卖出信号阶梯减仓：
    - 持仓且 strong_sell_signal>=1：默认按本轮最大持股数的 10% 减仓，累计最多 30%。
    ...
    def _submit_sell_signal_step_position(self, data: Any) -> bool:
        ...
        if order is not None:
            ...
            self.order_meta[order.ref] = {
                "signal": "FACTOR_CHECK_SELL_SIGNAL_STEP_POSITION",
