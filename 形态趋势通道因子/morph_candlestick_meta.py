...
SIGNAL_DISPLAY_NAME_ZH: dict[str, str] = {
    "harami_bullish": "看涨孕线",
    "harami_bearish": "看跌孕线",
    ...
    "tower_top": "塔型顶部",
    "tower_bottom": "塔型底部",
    "three_mountains": "三山形态",
    "three_rivers": "三川形态",
    "rising_three_methods": "上升三法",
    "falling_three_methods": "下降三法",
    "bullish_marubozu": "多头母子线",
    "bearish_marubozu": "空头母子线",
    "pregnant_marubozu": "孕母线",
    "tombstone_marubozu": "墓碑线",
    "three_inside_up": "三内部上涨线",
    "three_inside_down": "三内部下跌线",
    "doji_pause": "停顿线",
    "golden_needle_bottom": "金针探底",
    "rocket_launch": "火箭发射",
    "man_jiang_hong": "满江红",
    "hanging_man_enhanced": "上吊线（增强版）",
    "heaven_line": "天堂线",
    "dark_cloud_line": "乌云线",
    "same_low_price": "相同低价",
    "takuri": "塔库里",
    "false_breakout_trap_bullish": "看涨假突破陷阱",
    "false_breakout_trap_bearish": "看跌假突破陷阱",
    "short_body_candle_bullish": "看涨短实体蜡烛",
    "short_body_candle_bearish": "看跌短实体蜡烛",
    "long_legged_doji_bullish": "看涨长脚十字星",
    "long_legged_doji_bearish": "看跌长脚十字星",
    "three_outside_up": "三外部上涨",
    "three_outside_down": "三外部下跌",
    "marubozu_bullish": "看涨光头光脚线",
    "marubozu_bearish": "看跌光头光脚线",
    "spinning_top_bullish": "看涨纺锤线",
    "spinning_top_bearish": "看跌纺锤线",
    "high_wave_bullish": "看涨高浪线",
    "high_wave_bearish": "看跌高浪线",
    "homing_pigeon_bullish": "看涨家鸽形态",
    "homing_pigeon_bearish": "看跌家鸽形态",
    "same_high_price": "相同高价",
}
